<html lang="pt-br" dir="ltr">
  ...
  <body style="margin: 0; padding: 0; font-family: 'GT Walsheim'; background: #f7f7f7">
    ...
    <div class="container-fluid">
      <div class="row w-100 pt-5 text-center pl-5 pr-4 ">
        <div class="col-sm-4 text-center" style="cursor: pointer;" onclick="abrirProdutos()">
          <img src="img/modelo1.jpg" alt="" class="img-fluid rounded mx-auto d-block">
          <div class="pt-2 pb-2">
            <span style="color: #6b6b6b; font-size: 14px;">Vestido Bonito</span><br>
            <span>R$295,00</span>
          </div>
        </div>
        <div class="col-sm-4 text-center" style="cursor: pointer;" onclick="abrirProdutos()">
