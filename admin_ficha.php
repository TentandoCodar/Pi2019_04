...
<html lang="pt-br" dir="ltr">
  <head>
    ...
    <title>Ficha Técnica | Wave</title>
  </head>
  <body style="font-family: 'GT Walsheim'; color: #000; background-image: linear-gradient(60deg, #f2f2f2, #f2f2f2);" class="" id="body">
    ...
    <div class="pl-4 pr-4 pt-3 pb-3 botao_more" onclick="abrirCadastroFicha()" id="button_more">
    ...
    <div class="pt-5 text-center" style="background-image: linear-gradient(60deg, #f2f2f2, #f2f2f2);">
      <div class="pt-5 pb-5">
        <div class="pt-5 pb-5">
          <h1 style="color: #000; font-weight: 700; font-family: 'GT Walsheim'">FICHAS TÉCNICAS</h1>
        </div>
