...
<html lang="pt-br" dir="ltr">
  <head>
    ...
    <title>Funcionários | Wave</title>
  </head>
  <body style="font-family: 'GT Walsheim'; color: #000; background-image: linear-gradient(60deg, #f2f2f2, #f2f2f2);" id="body">
    <?php include 'partes/cabecalho.php' ?>


    <div class="pl-4 pr-4 pt-3 pb-3 botao_more" onclick="abrirCadastroUsuario()" id="button_more">
    ...
    <!-- ___________________LISTAGEM DE USUARIOS______________________ -->

    <div class="pt-5 text-center" style="background-image: linear-gradient(60deg, #f2f2f2, #f2f2f2);">
      <div class="pt-5 pb-5">
        <div class="pt-5 pb-5">
          <h1 style="color: #000; font-weight: 700; font-family: 'GT Walsheim'">FUNCIONÁRIOS</h1>
        </div>
    ...
    <!-- ________________MODAL COM INFO DOS USUARIOS_____________________ -->

    <div class="container-fluid position-fixed vh-100 vw-100 modal_admin" id="modal_products">
      <div class="row h-100 pt-4 pb-3 align-items-center style_modal">
        <i class="fas fa-times position-absolute icone_modal"  onclick="fecharModalProducts()"></i>
        <div class="col pl-5 pr-5 pt-5 pb-5 text-center">
          <h1 id="UserName" style="" class="pl-3 pr-3 text_modal_titulo"></h1>
          <div class="pt-5">
            <span class="pt-2">email.</span><p id="UserEmail" class="text_modal_texto"></p>
            <span class="pt-2">codigo.</span><p id="UserCode" class="text_modal_texto"></p>
          </div>
        </div>
      </div>
    </div>
